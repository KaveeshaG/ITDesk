	...
	<head>
		...
		<body>
			  ...
			  <header id="header" id="home">
			    <div class="container">
			    	<div class="row align-items-center justify-content-between d-flex">
				      <div id="logo">
				        <a href="index.html"><img src="Index/img/logo.png" alt="" title="" /></a>
				      </div>
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
				          ...
				          <li><a class="ticker-btn" href="#login">Sign in</a></li>				          
				        </ul>
			...
			<!-- Start feature Area -->
			<section class="feature-area pb-100" id="login">
				<div class="container">
					<div class="row mockup-container">
						<img class="mx-auto d-block img-fluid" src="Index/img/laptop.png" alt="">
					</div>
					<div class="row d-flex justify-content-center">
						<div class="menu-content pt-100 pb-60 col-lg-10">
							<div class="title text-center">
								<h1 class="mb-10">Choose your Role and Sign in</h1>
			...
			<section class="latest-blog-area section-gap" id="news">
				<div class="container">
					<div class="row d-flex justify-content-center">
					...
					<div class="row">
						<div class="col-lg-6 single-blog">
							<img class="img-fluid" src="Index/img/b1.png" alt="">
							<a href="#"><h4>Portable latest Fashion for young women</h4></a>
							<p>
								Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore  et dolore.
							</p>
							<p class="post-date">20th May, 2019</p>
						</div>
						<div class="col-lg-6 single-blog">
							<img class="img-fluid" src="Index/img/b2.png" alt="">
							<a href="#"><h4>Portable latest Fashion for young women</h4></a>
							<p>
								Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore  et dolore.
							</p>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Online Help Desk by <a href="index.html" target="_blank">ITDesk</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
								</p>	
							</div>
						</div>
